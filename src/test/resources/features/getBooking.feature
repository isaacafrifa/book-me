Feature: Retrieve booking details
  ...
  Scenario: Retrieve a booking by ID (Success)
    ...
    When the endpoint "/bookings/1" is called to get a single booking
